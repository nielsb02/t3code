...
export const SETTINGS_SEARCH_ITEMS = [
  ...
  },
  {
    ...
    scope: "project-defaults",
    searchTerms: [
      "model workspace browser machines projects inheritance automatic pull checkout grouping actions scripts repositories paths polyrepo submodules t3.json new thread default runtime mode supervised approvals auto accept edits full access",
    ],
  },
  {
    id: "color-scheme",
