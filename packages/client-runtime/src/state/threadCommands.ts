...
import {
  ...
  type RefreshThreadContextInput,
  type ShareThreadContextInput,
  type CancelThreadContextInput,
...
export type {
  ArchiveThreadInput,
  CreateThreadInput,
  RefreshThreadContextInput,
  ShareThreadContextInput,
  CancelThreadContextInput,
  DeleteThreadInput,
...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  const commands = {
    ...
    refreshContext: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:refresh-context",
      execute: (input: RefreshThreadContextInput) => refreshThreadContext(input),
      scheduler,
      concurrency,
    }),
    cancelContext: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:cancel-context",
      execute: (input: CancelThreadContextInput) => cancelThreadContext(input),
      scheduler,
      concurrency,
    }),
    shareContext: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:share-context",
      execute: (input: ShareThreadContextInput) => shareThreadContext(input),
      scheduler,
      concurrency,
    }),
